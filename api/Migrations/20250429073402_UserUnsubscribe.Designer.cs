...
namespace Api.Features.Migrations
{
    ...
    [Migration("20250429073402_UserUnsubscribe")]
    partial class UserUnsubscribe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Features.Auth.Models.User", b =>
                {
                    ...
                    b.Property<bool>("IsSubscribedToEmails")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Api.Source.Features.Game.QuestProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Api.Source.Features.Marketing.Models.Campaign", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Api.Source.Features.Marketing.Models.CampaignRecipient", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Api.Source.Features.Marketing.Models.EmailTemplate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Api.Source.Features.Game.QuestProgress", b =>
                {
                    ...
                    b.HasOne("Api.Source.Features.Game.Player", null)
            ...
            modelBuilder.Entity("Api.Source.Features.Marketing.Models.Campaign", b =>
                {
                    b.HasOne("Api.Source.Features.Marketing.Models.EmailTemplate", "EmailTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Source.Features.Marketing.Models.CampaignRecipient", b =>
                {
                    b.HasOne("Api.Source.Features.Marketing.Models.Campaign", "Campaign")
                        .WithMany("Recipients")
